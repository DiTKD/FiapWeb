...
namespace FiapWeb.Controllers
{
    public class PerguntasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,Descricao,Aluno")] Pergunta pergunta)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,Descricao,Aluno")] Pergunta pergunta)
        {
            if (id != pergunta.id)
            {
                return NotFound();
